    ...
    <div class="app-main__inner">
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Cetak Data Pasien
                        <div class="page-title-subheading">
                            Cetak Data Pasien adalah halaman untuk mengedit data pasien.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-xl-12">
                <div class="mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title mb-3">Print Data Pasien</h5>
                        <form action="{{ route('pasien.edit', $pasien->id) }}" method="post" class="needs-validation">
                            ...
                            <button type="submit" class="btn btn-primary mt-2">
                                <i class="fas fa-user-edit"></i> Print
                            </button>
